  ...
  return (
    <div className={styles.app}>
      <nav className={styles.sidebar}>
        <div className={styles.brand}><img src="/favicon.svg" width="22" height="22" alt="" style={{ borderRadius: 5, flexShrink: 0 }} />Soma <span className={styles.betaBadge}>beta</span></div>
